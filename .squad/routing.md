...
|-----------|----------|----------|
| Terraform code | Donut | Module refactoring, resource definitions, provider config, variable structure |
| Azure architecture | Carl | Landing zone strategy, networking design, resource topology decisions |
