...
| 5 | `172.20.80.0/20` | App LZ — **Fabric-byoVnet** | `172.20.80.0/24` (Private Endpoints — workspace PE). Claimed 2026-04-26. |
...
| 5 | `172.21.80.0/20` | Reserved — Fabric-byoVnet (region 1, future) | — |
